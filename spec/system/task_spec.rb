...
RSpec.describe 'Task', type: :system do
  ...
  let(:completed_task) { FactoryBot.create(:task, :completed_task, project_id: project.id) }
  ...
  describe 'Task編集' do
    context '正常系' do
      xit 'Taskを編集した場合、一覧画面で編集後の内容が表示されること' do
        ...
        fill_in 'Deadline', with: Date.parse("2019/08/01")
  ...
  describe 'Task削除' do
    context '正常系' do
      ...
      it 'Taskが削除されること' do
        ...
        expect(page).not_to have_selector 'td', text: task.title
